    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            if 'Draft' in request.POST:
                ...
                if request.user.is_superuser:
                    messages.success(request, f'Project proposal {title} was edited!')
                else:
